...
import { TusodrawState, NormalizedZoomValue } from "./types";
...
export const getDefaultAppState = (): Omit<TusodrawState,
...
> => {
  return {
    ...
    zoom: { value: 1 as NormalizedZoomValue, translation: { x: 0, y: 0 } },  //value: 1 as NormalizedZoomValue, 
    ...
    T extends Record<keyof TusodrawState, Values>
    >(
    config: { [K in keyof T]: K extends keyof TusodrawState ? T[K] : never },
    ) => config)({
